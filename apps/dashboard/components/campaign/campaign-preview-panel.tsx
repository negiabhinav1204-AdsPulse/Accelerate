...
export function CampaignPreviewPanel({
  ...
  // Images are generated server-side (worker) and delivered via image_update SSE
  // events. Client-side regeneration is intentionally removed — Imagen is
  // non-deterministic so any re-call produces different images, breaking UX.
